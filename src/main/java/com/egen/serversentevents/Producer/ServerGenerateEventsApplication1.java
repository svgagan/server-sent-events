...
public class ServerGenerateEventsApplication1 {

    private static final Logger log = LoggerFactory.getLogger(ServerGenerateEventsApplication1.class.getName());

    private static final String TOPIC = "sse-test-topic-101";
    private static final String BOOTSTRAP_SERVERS = "localhost:9092";
    private static final String CLIENT_ID_CONFIG = "string-producer-1";

    private final KafkaSender<String, String> sender;
    private final SimpleDateFormat dateFormat;

    public ServerGenerateEventsApplication1(String bootstrapServers){
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ServerGenerateEventsApplication1 producer = new ServerGenerateEventsApplication1(BOOTSTRAP_SERVERS);
